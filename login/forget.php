    ...
    <div id="wrapper">
                    ...
                    <ul>
                        ...
                        <li class="nav-cha">
                            ...
                            <ul class="nav-con">
                                ...
                                ?>
                                <!-- <li><a href="thucdon.php?page=cafe">Cafe</a></li>
                                <li><a href="thucdon.php?page=banh">bánh</a></li>
                                <li><a href="thucdon.php?page=tra">Trà</a></li>
                                <li><a href="thucdon.php?page=hatcafe">Hạt Cafe</a></li> -->
                            </ul>
                        </li>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            try {
                ...
                $nguoigui = 'thobe6250@gmail.com'; // Tài khoản Email
                $matkhau = 'jungkook97line'; // Mật khẩu Email
                $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                $mail->Port = 465;  // Port kết nối: khai báo 465 hoặc 587                


                // Recipients - Người nhận
                $tennguoigui = 'Phương Nguyên'; // Tên người gửi lấy từ form nhập
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->setFrom($nguoigui, $tennguoigui); //mail và tên người nhận 
                $to = $email; // Email cần gửi đến lấy từ form nhập
                $to_name = "Phương Nguyên"; // Tên người cần gửi đến
