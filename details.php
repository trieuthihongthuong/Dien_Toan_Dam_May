    ...
    <div class="container">
        ...
        <section class="main">
            <section class="oder-product">
                <div class="title">
                    <section class="main-order">
                        <h1><?= $product['title'] ?></h1>
                        <div class="box">
                            <img src="<?='admin/product/'.$product['thumbnail'] ?>" alt="" style="width: 250px; height: 250px; margin-right: 20px;" >
                            <div class="about" style="flex-grow: 1;">
                                <p ><?= $product['content'] ?></p>
                                <div class="number">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Thực đơn tại quán <span class="green">Cafena Coffee</span></h1>
                </div>
